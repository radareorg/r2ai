...
`)||""}function je(e,t){let n=new Set;return e.filter(o=>{let i=t(o);return n.has(i)?!1:(n.add(i),!0)})}function z(e){let t=fe(e)?.[0]||null;return{baseUrl:pe(e),headers:me(he(e,t))}}function Fe(e){let{baseUrl:t,headers:n}=z(e);return De(t+"/v1/models",n,o=>o.id)}function Be(e){let{baseUrl:t,headers:n}=z(e),o=A(t+"/api/tags",n),i=O(o.error);return i?(console.error(i),"error invalid response"):o.models?.map(a=>a.name).join(`
